...
export default function Sidebar(props) {
    ...
    return (
        ...
        <div className="title-container">Clause for renters best interest for a rental property
          <button className="icon-right" onClick={props.onClick} >
          ...
          <div className="dropdown">
            <p className="edit">
              <svg onClick={handleEdit}xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pencil-square" viewBox="0 0 16 16">
